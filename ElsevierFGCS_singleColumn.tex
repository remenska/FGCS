...
LHC grid resources with up to 30K simultaneously running jobs (Fig.~\ref{fig:LHCb-resource-usage}, top) and over 100000 jobs executed per day, during peak processing periods.
About 10PB of data is stored and visible in the LHCb file catalogs, with daily data transfers among storage units reaching 3Gbps (Fig.~\ref{fig:LHCb-resource-usage}, bottom).
\begin{figure*}[tp!]
  \centering
...
\begin{figure}[tp]
\begin{center}
 \includegraphics[width=0.5\linewidth,keepaspectratio=true]{./graphics/Figure4.png}
\end{center}
